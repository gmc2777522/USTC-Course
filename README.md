...
* [.](.)
    * [编译原理和技术](./编译原理和技术)
        * [exams](./编译原理和技术/exams)
        * [lab-郑启龙](./编译原理和技术/lab-郑启龙)
    * [操作系统原理与设计](./操作系统原理与设计)
        * [exams](./操作系统原理与设计/exams)
        * [notes](./操作系统原理与设计/notes)
    * [c程序设计](./c程序设计)
        * [程序设计2-lab](./c程序设计/程序设计2-lab)
    * [计算机体系结构](./计算机体系结构)
        * [labs](./计算机体系结构/labs)
    * [计算机网络](./计算机网络)
        * [exams](./计算机网络/exams)
    ...
    * [计算机组成原理](./计算机组成原理)
        ...
        * [exams](./计算机组成原理/exams)
        * [notes](./计算机组成原理/notes)
        * [verilog-lab](./计算机组成原理/verilog-lab)
    * [模拟与数字电路](./模拟与数字电路)
        * [notes](./模拟与数字电路/notes)
    * [数据结构](./数据结构)
        * [codes](./数据结构/codes)
    ...
    * [Web-信息处理与应用](./Web-信息处理与应用)
        * [homework](./Web-信息处理与应用/homework)
        * [labs](./Web-信息处理与应用/labs)
        * [notes](./Web-信息处理与应用/notes)
    * [微机原理与系统](./微机原理与系统)
        * [labs](./微机原理与系统/labs)
        * [notes](./微机原理与系统/notes)
